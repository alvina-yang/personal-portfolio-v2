    ...
    <main className="min-h-screen">
      ...
      <div className="px-8 py-16 md:px-16 lg:px-24">
        ...
        <div className="space-y-6 text-base leading-relaxed">
          ...
          <p>
            I also like building mildly unhinged projects for fun. Recently that has looked like a <a href="https://devpost.com/software/orbit-59jths" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70 transition-opacity"> doxer</a> (Hack the North winning project, using facial recognition to surface publicly available information about someone), a <a href="https://devpost.com/software/i-cheated-lol" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70 transition-opacity">hackathon cheating assistant</a> that rewrites your commits and files for you, and <a href="https://devpost.com/software/irrizzistable-glasses" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70 transition-opacity">Rizz Glasses</a>, an AI pair of glasses that feeds you conversation prompts in real time. Please don&apos;t ban me, MLH.
          </p>
