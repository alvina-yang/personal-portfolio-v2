	...
	return (
		<div className="space-y-6">
			<p>
				...
				Vim. And honestly? It&#39;s actually kind of fun.
			</p>
			...
			<p>
				Vim is <em>modal</em> — instead of just typing into a file, you switch between modes:
			</p>
			...
			<p>
				...
				its config file. It runs every time you open a new terminal window, so anything you put
				in there — aliases, plugins, environment setup — just works automatically. Think of it
				as your terminal&#39;s startup checklist.
			</p>
